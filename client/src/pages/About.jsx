    ...
    <div className="card top">
      ...
      <div className="paragraph">
        <p>
          ...
          into unfiltered expression: Share your uncensored thoughts, opinions,
        ...
        <p>
          ...
          on your own terms, fostering mindful exploration without the demands
          of traditional social media. Embrace the benefits of being
          "antisocial" <br></br>Honesty without fear: Speak your truth freely,
          knowing your identity is protected. <br></br>
          <span className="spice"> Discover diverse perspectives </span>:
          Explore a wider range of opinions without societal norms or peer
          pressure. <br></br>
          Boost self-awareness: Observe your reactions and curate a space that
          reflects your genuine interests. <br></br>Enjoy guilt-free
          entertainment:{' '}
        ...
        <p>
          ...
          where your thoughts can truly roam free. Sign up for{' '}
          <span className="spice">SocialEyes</span> today and start discovering
          the world, one anonymous post at a time.
        </p>
      </div>
    </div>
  );
